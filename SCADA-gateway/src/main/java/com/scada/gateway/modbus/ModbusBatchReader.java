...
public class ModbusBatchReader {
    ...
    private static Object decode(TagEntity tag, int[] regs, int off) {
        ...
        // Регистр беззнаковый, а целый тег знаковый: в модели приборов ptusa
        // отрицательные коды состояния законны. Без разворота записанное значение
        // −5 вернулось бы оператору как 65531.
